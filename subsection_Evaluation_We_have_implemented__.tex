...
Table \ref{prediction_standard} includes a comparison of performance of our prediction model against the standard datasets \textit{euretail} (quarterly retail trade index in the Euro area from 1996 to 2011), \textit{sunspotarea} (annual averages of the daily sunspot areas, in units of millionths of a hemisphere, for the full sun) and \textit{oil} (annual oil production in millions of tonnes from Saudi Arabia between 1965 and 2010) available in the forecast package in R \cite{forecastPackage}.

\begin{table}[]
\label{prediction_standard}
\centering
