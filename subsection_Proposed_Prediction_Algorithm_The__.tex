...
\end{enumerate}
While this algorithm does not specify a particular PaaS workload or performance, it can be used with any time-variant metrics such as CPU and memory utilization and request in flight.\\