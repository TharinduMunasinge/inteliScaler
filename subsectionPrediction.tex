...
Here f is a predefined function which calculate penalizing factor based on the percentage of performance degradation. $n_{opt} = arg \min_{n \in N \land n \in [min, max]}C_t(n) $
\\
